...
int ig[nbins];
double vtail, ptail, sd, bins_size;
...
double err_pot, err_pres, err_kin, err_etot, err_temp, err_g[nbins];
...
int npart;
double beta,temp,energy,vol,rho,box,rcut, delta_v[nbins];
